...
const Login = () => {
  ...
  const setKeycloakServerDomainIndex = useKeyloakDomain(
    (state) => state.setDomainIndex
  );
    ...
    <div className="h-screen w-screen flex justify-center items-center bg-slate-50">
      <Card className="w-[600px]">
        <CardHeader>
          ...
          <RadioGroup
            defaultValue={keycloakServerDomainIndex.toString()}
            onValueChange={(value) => setKeycloakServerDomainIndex(Number(value))}
          >
